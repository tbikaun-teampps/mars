...
-- \restrict DCSqzDkALgwgRIOYyAxwUsqJvttBGCQKY6yr2zfZszesFgwIagVuVY08GNJUm4U
...
SELECT pg_catalog.setval('"public"."material_insights_insight_id_seq"', 1, false);
...
SELECT pg_catalog.setval('"public"."material_reviews_review_id_seq"', 1, false);
...
SELECT pg_catalog.setval('"public"."review_checklist_checklist_id_seq"', 1, false);
...
-- \unrestrict DCSqzDkALgwgRIOYyAxwUsqJvttBGCQKY6yr2zfZszesFgwIagVuVY08GNJUm4U
